...
<div class="container">
	<div class="row sidebar-row">
		...
		<!-- Left Sidebar -->
		<?php if ( is_active_sidebar('left-product-detail') && floris_sidebar_product() == 'left' ):
		...
		<div id="contents-detail" <?php floris_content_product_detail(); ?> role="main">
			<?php
				/**
		...
		<!-- Right Sidebar -->
		<?php if ( is_active_sidebar('right-product-detail') && floris_sidebar_product() == 'right' ):
