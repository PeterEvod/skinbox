...
<div class="container">
	<div class="row sidebar-row">		
		...
		<div class="single main <?php floris_content_blog(); ?>" >
			...
			<div <?php post_class(); ?>>
						...
						<div class="entry-meta clearfix">
							...
							<div class="entry-comment">
								<a href="<?php comments_link(); ?>">
									...
									<?php echo ( $post->comment_count . ( ( $post->comment_count > 1 ) ? esc_html__(' Comments ', 'floris') : esc_html__(' Comment ', 'floris') ) ); ?>
								</a>
							</div>
							<?php if( ! has_post_thumbnail() ){ ?>
				...
				?>
						<div class="single-post-relate">
							<h4><?php esc_html_e('Related News', 'floris'); ?></h4>
							<div class="row">
							<?php
							...
							?>
								<div <?php post_class( $class_col ); ?> >
									...
									<div class="item-relate-img">
										...
										<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('floris_related_post'); ?></a>
									</div>
									<?php } ?>
									...
									<div class="item-relate-content">
										...
										<div class="entry-meta">
											<div class="entry-comment">
												...
												<?php 
													...
													if($qty_comment > 1 ){
														echo ( $qty_comment. ' '. esc_html__(' Comments ', 'floris') );
													} else {
														echo ( $qty_comment. ' '. esc_html__(' Comment ', 'floris') );
													}
												?>
											</div>
											<?php if(get_the_tag_list()) { ?>
										...
										<a class="read-more" href="<?php the_permalink(); ?>"><i class="fa fa-caret-right"></i><?php echo esc_html__('Read More','floris');?></a>
									</div>
								</div>
								<?php
									endwhile;
